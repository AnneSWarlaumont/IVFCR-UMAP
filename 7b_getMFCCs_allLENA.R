...
for (wavDir in wavDirs){
  ...
  for (wavFile in wavFiles){
    ...
    # HERE on adapting the code below to apply to the full set of IVFCR LENA labels
    specDir <- paste(regmatches(wavFile,regexpr("^[^_]*_[^_]*_*",wavFile)),"spectralFeatures/",sep="")
